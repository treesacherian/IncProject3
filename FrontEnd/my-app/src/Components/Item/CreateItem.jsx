    ...
    <div className="card-group d-inline-flex padding">
      <form
        onSubmit={(e) => {
          e.preventDefault();
          axios
            .post("http://localhost:8089/item/create", { name, price, image })
            .then((response) => {
              setName("");
              setPrice();
              setImage();
      ...
      >
        <div className="container" id="CreateItem">
          <div className="row">
            ...
            <div className="col">
              <div label htmlfor="price" className="form-label ">
                Price
              </div>
              <input
                type="number"
            ...
            <div className="col">
              <div label htmlfor="image" className="form-label">
                Image
              </div>
              <input
                size=""
        ...
        <div>
          <button
            type="submit"
            id="SubmitCreateItem"
            className="btn btn-success col-2 row-2"
          >
            {" "}
            Submit{" "}
          </button>
